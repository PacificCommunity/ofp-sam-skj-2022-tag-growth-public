...
# Fit VB model to otolith and tag-recapture data
spcdat_comb<-data.frame(len=c(spcdat$lenRel, spcdat$lenRec, Leroy_oto$FL_cm))
...
# As @ 14 June 2022, we need to make decisions about the alternative growth curves we take forward for
...
# To obtain the most appropriate model for iii), we have selected two datasets that we consider the most reliable/informative 
# for this purpose. These are ranked 1 and 2 below. 
